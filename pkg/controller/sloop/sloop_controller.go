...
import (
	...
	testv1beta1 "github.com/hawq-cn/apicrd-example/pkg/apis/test/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &testv1beta1.Sloop{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=test.hawq.org,resources=sloops,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileSloop) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Sloop instance
	instance := &testv1beta1.Sloop{}
