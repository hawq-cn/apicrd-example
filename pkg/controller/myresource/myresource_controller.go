/*
Copyright 2018 The HAWQ team Authors.
...
import (
	...
	corev1alpha1 "github.com/hawq-cn/apicrd-example/pkg/apis/core/v1alpha1"
...
// Add creates a new MyResource Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1alpha1.MyResource{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by MyResource - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &corev1alpha1.MyResource{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=core,resources=myresources,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileMyResource) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the MyResource instance
	instance := &corev1alpha1.MyResource{}
